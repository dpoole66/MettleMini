...
namespace GoogleARCore.HelloAR {
    ...
    public class HelloARController2 : MonoBehaviour {
        ...
        //
        //UI objects
        public GameObject SearchingForPlaneUI, StartingUI, PlayingUI, EndingUI, QuitUI, DebugUI, b_Attack, b_Defend;
        ...
        IEnumerator RoundStarting() {
            ...
            while (currentstate == GAME_STATE.STARTING) {
                ...
                b_Attack.SetActive(false);
                b_Defend.SetActive(false);
                SearchingForPlaneUI.SetActive(true);
        ...
        IEnumerator RoundPlaying() {
            ...
            while (currentstate == GAME_STATE.PLAYING) {
                ...
                b_Attack.SetActive(true);
                b_Defend.SetActive(true);
        ...
        IEnumerator SpawnMettles(){
            ...
            var mettleEnemyInstance = Instantiate(MettleEnemyPrefab, m_EnemySpawn.transform.position, Quaternion.identity);
