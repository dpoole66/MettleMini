...
public class DumDum : MonoBehaviour {
    ...
    [HideInInspector] public Animator anim;                     // Animator to Anim converter
    [HideInInspector] public int idleState = Animator.StringToHash("Base Layer.Idle"); // String to Hash conversion for Mecanim "Base Layer"
    [HideInInspector] public int runState = Animator.StringToHash("Base Layer.Run");  // String to Hash for Mecanim "Base Layer Run"
